...
:partner-contributors: Jack Iu, Henry Su, and Gloria Vargas
:quickstart-contributors: Dave Brussel, Dave Nickles, Andrew Glenn, and Troy Ameigh, AWS Quick Start team
